...
const ::std::string iceC_Demo_Printer_pprintString_name = "pprintString";
...
/// \cond INTERNAL
bool
Demo::Printer::_iceD_pprintString(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    inS.endReadParams();
    this->pprintString(::std::move(iceP_str), current);
...
Demo::Printer::_iceDispatch(::IceInternal::Incoming& in, const ::Ice::Current& current)
{
    ...
    switch(r.first - iceC_Demo_Printer_ops)
    {
        ...
        case 4:
        {
            return _iceD_pprintString(in, current);
        }
        default:
        {
            assert(false);
...
/// \cond INTERNAL
void
Demo::PrinterPrx::_iceI_pprintString(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<void>>& outAsync, const ::std::string& iceP_str, const ::Ice::Context& context)
{
    outAsync->invoke(iceC_Demo_Printer_pprintString_name, ::Ice::OperationMode::Normal, ::Ice::FormatType::DefaultFormat, context,
...
::Ice::AsyncResultPtr
IceProxy::Demo::Printer::_iceI_begin_pprintString(const ::std::string& iceP_str, const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
    ::IceInternal::OutgoingAsyncPtr result = new ::IceInternal::CallbackOutgoing(this, iceC_Demo_Printer_pprintString_name, del, cookie, sync);
    try
    {
        result->prepare(iceC_Demo_Printer_pprintString_name, ::Ice::Normal, context);
        ::Ice::OutputStream* ostr = result->startWriteParams(::Ice::DefaultFormat);
        ostr->write(iceP_str);
        result->endWriteParams();
        result->invoke(iceC_Demo_Printer_pprintString_name);
    }
...
void
IceProxy::Demo::Printer::end_pprintString(const ::Ice::AsyncResultPtr& result)
{
    _end(result, iceC_Demo_Printer_pprintString_name);
}
...
Demo::Printer::_iceD_pprintString(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    istr->read(iceP_str);
    inS.endReadParams();
    this->pprintString(iceP_str, current);
    inS.writeEmptyParams();
    return true;
}
/// \endcond

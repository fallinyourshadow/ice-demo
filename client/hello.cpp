...
Test::Hello::_iceD_SayHello(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    inS.endReadParams();
    ::std::string ret = this->SayHello(::std::move(iceP_username), current);
...
void
Test::HelloPrx::_iceI_SayHello(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::std::string>>& outAsync, const ::std::string& iceP_username, const ::Ice::Context& context)
{
    _checkTwowayOnly(iceC_Test_Hello_SayHello_name);
...
void
::IceProxy::Test::_readProxy(::Ice::InputStream* istr, ::IceInternal::ProxyHandle< ::IceProxy::Test::Hello>& v)
{
    ::Ice::ObjectPrx proxy;
    istr->read(proxy);
    if(!proxy)
...
::Ice::AsyncResultPtr
IceProxy::Test::Hello::_iceI_begin_SayHello(const ::std::string& iceP_username, const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
    _checkTwowayOnly(iceC_Test_Hello_SayHello_name, sync);
...
{
    ::Ice::AsyncResult::_check(result, this, iceC_Test_Hello_SayHello_name);
    ::std::string ret;
...
Test::Hello::_iceD_SayHello(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    inS.endReadParams();
    ::std::string ret = this->SayHello(iceP_username, current);
...
Test::Hello::_iceWriteImpl(::Ice::OutputStream* ostr) const
{
    ...
    Ice::StreamWriter< ::Test::Hello, ::Ice::OutputStream>::write(ostr, *this);
    ostr->endSlice();
}
...
{
    istr->startSlice();
    Ice::StreamReader< ::Test::Hello, ::Ice::InputStream>::read(istr, *this);
    istr->endSlice();
}
